...
export type WorkflowKey =
  ...
  | 'workflow.calls.suffix'
  | 'workflow.request'
  | 'workflow.request.context'
  | 'workflow.response'
  | 'workflow.response.pending'
  | 'workflow.response.toolOnly'
  | 'workflow.finalReply'
  | 'workflow.system'
  | 'workflow.messages'
  | 'workflow.toolDefinitions'
  | 'workflow.toolCalls'
  | 'workflow.reasoning'
  | 'workflow.content'
  | 'workflow.input'
  | 'workflow.inputUncached'
  | 'workflow.cacheRead'
  | 'workflow.cacheWrite'
  | 'workflow.output'
  ...
  | 'workflow.tool.call'
  | 'workflow.tool.complete'
  | 'workflow.request.details'
  | 'workflow.response.details'
  | 'workflow.tool.details'
  | 'workflow.details.close'
  | 'workflow.copy'
  | 'workflow.copied'
  | 'workflow.json.expand'
  | 'workflow.json.close'
  | 'workflow.json.dialog'
  | 'workflow.json.expandNode'
  | 'workflow.json.collapseNode'
  | 'workflow.config'
...
export const zh: Record<WorkflowKey, string> = {
  'view.workflow': '工作流',
  ...
  'workflow.json.expandNode': '展开 JSON 节点',
  'workflow.json.collapseNode': '收起 JSON 节点',
...
/** English dictionary. */
export const en: Record<WorkflowKey, string> = {
  ...
  'workflow.json.dialog': '{label} · JSON',
  'workflow.json.expandNode': 'Expand JSON node',
  'workflow.json.collapseNode': 'Collapse JSON node',
