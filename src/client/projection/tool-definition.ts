...
/** Workflow-owned root Tool lifecycle with nested Code Dispatch calls. */
const workflowToolDefinition: ConversationNodeDefinition<ToolState> = {
...
/**
 * Register the Workflow Tool lifecycle.
 *
