...
): WorkflowAssistantRequest | undefined {
...
/** Workflow-owned Assistant streaming, settlement, and request lifecycle. */
const workflowAssistantDefinition: ConversationNodeDefinition<AssistantState> = {
...
const workflowTurnEndDefinition: ConversationNodeDefinition<TurnEndState> = {
...
/**
 * Register the Workflow Assistant lifecycle.
 *
